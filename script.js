function converterDrive(url) {
    ...
    return idMatch ? "https://drive.google.com/uc?id=" + idMatch[1] : url;
}

const conteudos = [
    // --- FILMES (TODOS OS 50 DA LISTA) ---
    ...
    { titulo: "CORINGA", videoID: "https://motor.voltti.cloud/stream/62?hash=496cb3", capa: "https://drive.google.com/file/d/1EXxDLyulMeWCaEtI-owejIPIULo1xhpc/view?usp=sharing", tipo: "filme", genero: "Drama" },
...
function darPlay(url, titulo) {
    ...
    const placeholder = document.getElementById('hero-section');
...
function abrirMenuColecao(item) {
    ...
    document.getElementById('current-title').innerText = item.titulo + " - Selecione o Episódio";
    epList.innerHTML = "";
