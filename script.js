...
const conteudos = [
    ...
    { titulo: "Tanque de Guerra", videoID: "https://motor.voltti.cloud/stream/74?hash=e15450", tipo: "filme", genero: "Ação" },
    ...
    for (const gen of generos) {
        ...
        for (const item of itens) {
            ...
            card.onclick = () => {
                ...
                document.getElementById('main-player').src = item.videoID;
                document.getElementById('video-title').innerText = item.titulo;
